$( document ).ready(function()
{
    ...
    {        
        data.doctrines.forEach(function(doctrine, i_doctrine){
            ...
            // CATEGORIAS - BODY
            $('<h2 id="'+doctrine.slug+'">'+doctrine.name+' <img src="images/ico-link-hover.svg" class="iconLink" alt="A Doutrina de Deus" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-custom-class="custom-tooltip" title="Copiar link"></h2><p class="lead text-white mb-5">'+doctrine.description+'</p><div id="detalheCat'+i_doctrine+'"></div>').appendTo("#doutrinasDetalhes");
            ...
            doctrine.belief.forEach(function(belief, i_belief){
                ...
                // SUBCATEGORIAS - BODY
                $('<h3 class="text-white" id="'+belief.slug+'">'+belief.name+' <img src="images/ico-link-hover.svg" class="iconLink" alt="'+belief.name+'" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-custom-class="custom-tooltip" title="Copiar link"></h3><p class="lead text-white">Crença Fundamental (Hinos de '+belief.firstHymn+' a '+belief.lastHymn+')</p><p class="text-white mb-3">'+belief.description+'</p><table class="table table-dark table-hover" style="margin-bottom: 100px;"><thead><tr><th scope="col" class="text-center" style="width: 15%;">Número</th><th scope="col">Hino</th><th scope="col" class="text-center" style="width: 15%;">Vídeo</th></tr></thead><tbody id="hinosCat'+i_doctrine+'Sub'+i_belief+'"></tbody></table>').appendTo('#detalheCat'+i_doctrine);
