    ...
    Cart: {
        ...
        creatingElementForProduct: function(id, quantity) {
            ...
            xhr.onload = function () {
                ...
                CPBCheckout.init();
                CPBCheckout.config.api.urlBase = 'https://ecommerce-api-alpha.cpb.com.br/v1/';
            ...
            if (data.code === 201) {
                ...
                if (data.results.payment.form == 1) {
                    ...
                    var paymentCreditCard = { 
                        ...
                        expiryDate: "0820",
                        number: "5000000000000001",
                        orderId: data.results.order.id,
                        authorizerInternalId: "2",
                        cardholder: "JAMES M MARTINS",
